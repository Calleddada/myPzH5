<template>
    <div class="container">
        ...
        <StatusBar item="0"/>
        <van-cell class="cell" style="background-color: #f5f6f8;">
            <template #title>
                <van-image 
                    width="25"
                    heigth="25"
        ...
        <van-cell-group class="cell" title="&nbsp&nbsp服务需求">
          <van-field 
                    class="text" 
                    style="height: 100px;"
                    v-model="form.demand"  
                    placeholder="请简单描述您所需要的就诊科室..." 
                    /> 
        </van-cell-group>
...
const onConfirm = (item) => {
    ...
    // console.log(form.hospital_name);
    //关闭弹出层
    showHospital.value = false  
}
//选择时间
const currentDate = ref('')
const dataConfirm = (item) => {
    // console.log(item);
